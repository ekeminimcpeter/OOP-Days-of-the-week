...
#Code Deficiency:
    ...
    #Finds a previous nth day from the current day:
        #The referenced day is included in the subtracted days
#Improvement:
    #Hiden bug fixed:
        #self.__reference_day is set in constructor
'''
...
try:
    ...
    print(weekday)
    weekday.add_days(23)#Prim.Testdata 15
    print(weekday)
